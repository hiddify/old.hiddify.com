...
function HiddifyClient() {
  return (
    <section className="mb-28 lg:mb-60">
      <Container className="flex flex-col lg:flex-row lg:gap-2">
        ...
        <div className="py-4 lg:ps-16 flex flex-col items-center lg:items-start">
          <h3 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-gray-50">
            Hiddify Client
          </h3>
          <p className="text-2xl text-gray-800 dark:text-gray-300">
            A Client for every environment
          </p>
          <div className="flex gap-6 sm:gap-10 lg:gap-10 max-w-max mt-8 ">
          ...
          <h4 className="font-normal mt-12 text-xl text-center lg:text-start text-gray-800 dark:text-gray-300">
          ...
          <div className="mt-10 flex gap-10 sm:gap-32 lg:gap-12 justify-between">
            <Link tabIndex={-1} to="#">
